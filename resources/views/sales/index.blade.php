...
<div class="content-body">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <a href="{{route('sales.create')}}" class="btn btn-primary" title="Enregistrer une sortie"><i class="fa fa-plus-circle"></i> Enregistrer une sortie de produit</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display:flex;">
                            ...
                            <form action="{{route('sales.destroy', $sale->id)}}" method="POST" onsubmit="return confirmDelete()">
                                @csrf
                                @METHOD('DELETE')
