...
<div class="content-body">
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <a href="{{route('purchases_mat.create')}}" class="btn btn-primary" title="Enregistrer un approvisionnement de matériel"><i class="fa fa-plus-circle"></i> Enregistrer un approvisionnement de matériel</a>
